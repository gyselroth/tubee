...
abstract class AbstractObjects
{
     ...
     * Constructor.
     */
    public function __construct(GetOpt $getopt, MandatorFactory $mandator, LoggerInterface $logger, Scheduler $scheduler)
    {
        $this->logger = $logger;
        $this->getopt = $getopt;
    ...
    protected function updateObjects(array $objects, array $update): Objects
    {
        ...
        foreach ($update as $key => $object) {
            ...
            $mandator = $this->mandator->getOne($object['mandator']);
