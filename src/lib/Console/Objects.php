...
class Objects extends AbstractObjects
{
    ...
    public function diff(): Objects
    {
        ...
        $object_v1 = $this->manager->getMandator($mandator)->getDataType($datatype)->getOne($this->getFilter(), false);
        $object_v2 = $this->manager->getMandator($mandator)->getDataType($datatype)->getOne($this->getFilter(), false, $this->getVersion());
